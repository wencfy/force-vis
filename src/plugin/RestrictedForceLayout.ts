...
function layoutGenerator(resAlg?: string) {
        ...
        try {
          ...
          if (edges) {
            ...
            if (resAlg === 'linkLen') {
              simulation.force(
                "linkLen",
                forceLinkLen(edges as any)
              );
            } else if (resAlg === 'linkDir') {
              simulation.force(
                "linkPos",
...
registerLayout('restricted-force-layout', layoutGenerator());
registerLayout('restricted-node-distance-force-layout', layoutGenerator('dis'));
registerLayout('restricted-node-position-force-layout', layoutGenerator('pos'));
registerLayout('restricted-link-length-force-layout', layoutGenerator('linkLen'));
registerLayout('restricted-link-direction-force-layout', layoutGenerator('linkDir'));
